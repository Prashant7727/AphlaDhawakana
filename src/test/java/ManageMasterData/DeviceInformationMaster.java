...
//        // Wait for the error message to be displayed
		...
		driver.findElement(By.xpath("//*[@id=\"blockDiv\"]/div[1]/div/div[2]/a")).click();
		WebElement UpdateExaminationListFilePath = driver.findElement(By.xpath("//*[@id=\"file\"]"));
		UpdateExaminationListFilePath.sendKeys("C:/Users/jsingh/Downloads/testpdf.xlsx");
		try {
			TimeUnit.SECONDS.sleep(1);
		} catch (InterruptedException e) {
			e.printStackTrace();
...
//		}
		WebElement searchExaminationsEdit = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"example_filter\"]/label/input")));
		searchExaminationsEdit.sendKeys("10432");
		...
		driver.findElement(By.xpath("//*[@id=\"blockDiv\"]/div[1]/div/div[2]/a")).click();
		WebElement patientUpdateExaminationListFilePath = driver.findElement(By.xpath("//*[@id=\"file\"]"));
		patientUpdateExaminationListFilePath.sendKeys("C:/Users/jsingh/Downloads/testpdf.xlsx");
		try {
			TimeUnit.SECONDS.sleep(1);
		} catch (InterruptedException e) {
			e.printStackTrace();
...
//		}
		WebElement patientsearchExaminationsEdit = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"example_filter\"]/label/input")));
		patientsearchExaminationsEdit.sendKeys("10432");
		driver.findElement(By.xpath("//*[@id=\"example\"]/tbody/tr/td[6]/a")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"blockDiv\"]/div[1]/div/div[2]/a")).click();
		WebElement bothUpdateExaminationListFilePath = driver.findElement(By.xpath("//*[@id=\"file\"]"));
		bothUpdateExaminationListFilePath.sendKeys("C:/Users/jsingh/Downloads/testpdf.xlsx");
		try {
			TimeUnit.SECONDS.sleep(1);
		} catch (InterruptedException e) {
			e.printStackTrace();
...
//		WebElement searchExaminationsDlt2 = wait
//				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"example_filter\"]/label/input")));
//		searchExaminationsDlt2.sendKeys("10158");
...
//		}
		WebElement bothsearchExaminationsEdit = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"example_filter\"]/label/input")));
		bothsearchExaminationsEdit.sendKeys("10432");
		driver.findElement(By.xpath("//*[@id=\"example\"]/tbody/tr/td[6]/a")).click();
