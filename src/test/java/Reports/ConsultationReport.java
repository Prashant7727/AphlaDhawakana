...
@Test
	public void ConsultationReport() {
...
//        // Wait for the error message to be displayed
		...
		reports.click();
		WebElement consultationReport = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"assamConsultationPatReport\"]")));
		consultationReport.click();
