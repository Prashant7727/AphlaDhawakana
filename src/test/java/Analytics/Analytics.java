...
//        // Wait for the error message to be displayed
		...
		patientApp.click();
		WebElement startDateInput2 = driver.findElement(By.id("startDate"));
		WebElement endDateInput2 = driver.findElement(By.id("endDate"));
		startDateInput2.clear();
		endDateInput2.clear();
		startDateInput2.sendKeys("02/03/2023");
		endDateInput2.sendKeys("02/07/2023");
		// for all clinic generate table data
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div[5]/div[2]/input")).click();
		WebElement search3 = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"example_filter\"]/label/input")));
		search3.sendKeys("10002");
		...
		both.click();
		WebElement startDateInput3 = driver.findElement(By.id("startDate"));
		WebElement endDateInput3 = driver.findElement(By.id("endDate"));
		startDateInput3.clear();
		endDateInput3.clear();
		startDateInput3.sendKeys("02/03/2023");
		endDateInput3.sendKeys("02/07/2023");
		// for all clinic generate table data
		driver.findElement(By.xpath("//*[@id=\"labReportForm\"]/div[5]/div[2]")).click();
		WebElement search5 = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"example_filter\"]/label/input")));
		search5.sendKeys("10000");
		// select particular clinic
		wait.until(ExpectedConditions
				.elementToBeClickable(By.cssSelector("#labReportForm > div.radio > label:nth-child(2) > span.circle")))
				.click();
